...
### **Report Rules**
- Consumption views live in the `report` schema (not in `gold`) and are named after the business entity they describe.
- **`report.<entity>`**
  - Examples: `report.customers`, `report.products`.
